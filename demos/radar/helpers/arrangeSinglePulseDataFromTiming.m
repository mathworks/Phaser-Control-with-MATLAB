function outdata = arrangeSinglePulseDataFromTiming(indata,fs,tsweep,tstartsweep,tpulse,nPulses)
% Rearrange a single stream of data into an nSample x nPulse data matrix.
%
